...
class UniADRS(nn.Module):
    def __init__(self, n_channels=270, descriptor_dim=64, num_classes=1, stem_identity=True, device='cpu'):
...
class Normality_extractor(nn.Module):
    def __init__(self, descriptor_dim=64, channels=[128, 256, 512, 512, 1024], fusion_mode='LLLLL', device='cpu'):
