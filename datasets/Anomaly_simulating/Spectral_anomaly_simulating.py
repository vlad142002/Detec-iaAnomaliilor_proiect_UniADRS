...
class Spectral_simulator:
    def __init__(self, normal_ratio_range=(0.0015, 0.5), anomaly_ratio_range=(0.00024, 0.0015), transform=None):
        ...
        self.shift_transform = A.Compose([A.ShiftScaleRotate(shift_limit=0.0, p=1, interpolation=cv2.INTER_NEAREST), A.PiecewiseAffine(scale=(0.03, 0.05), interpolation=0, p=1.0)])
